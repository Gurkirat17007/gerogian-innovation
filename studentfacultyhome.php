...
if (isset($_POST['submit']))
{
    ...
    if($filename != '')
    {
        ...
        if (in_array($ext, $allowed))
        {
            ...
            header("Location: studentfacultyhome.php?st=success");
        }
        else
        {
            header("Location: studentfacultyhome.php?st=error");
        }
    }
    else {
           header("Location: studentfacultyhome.php");
...
<div class="container">
    ...
    <div class="uploadSection">
            <div class="row">
                <div class="col-xs-12">
                <form action="studentfacultyhome.php" method="post" enctype="multipart/form-data">
